        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '16px', marginBottom: '12px' }}>
            ...
            <div style={{ fontSize: '16px', fontWeight: 500, color: pnl24hChangeColor }}>
              {props.summary.pnl24h >= 0 ? '+$' : '-$'}{fmtPrice(Math.abs(props.summary.pnl24h))} / {props.summary.pnl24hPercent >= 0 ? '+' : ''}{props.summary.pnl24hPercent.toFixed(2)}%
            </div>
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '32px', fontWeight: 700, color: pnlChangeColor, marginBottom: '8px' }}>
            {props.summary.unifiedPnl >= 0 ? '+$' : '-$'}{fmtPrice(Math.abs(props.summary.unifiedPnl))}
          </div>
