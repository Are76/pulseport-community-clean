  ...
  return (
    <section className="mi-hero">
      <div className="mi-hero-copy">
        <p className="mi-label">Canonical cost-basis ledger</p>
        <strong className="mi-hero-value">{formatUsd(props.investedFiat)}</strong>
        <p className="mi-hero-caption">Invested fiat preserved as the historical entry anchor across Ethereum and Base inflows.</p>
      </div>
